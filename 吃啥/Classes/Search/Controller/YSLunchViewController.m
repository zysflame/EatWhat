...
@interface YSLunchViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation YSLunchViewController
...
//    appName=%E5%91%B3%E4%BB%96&keyCode=98194273FF8DE2BB05FE40ADF1871B05&timeStamp=1470617415035&materialId=1224&page=1&pageSize=10&insideCode=10013&appType=1&ipAddress=115.231.110.203&version=2.1.1&
    NSDictionary *dicPrograme = @{@"appName":@"味他",@"keyCode":@"98194273FF8DE2BB05FE40ADF1871B05",@"timeStamp":@"1470617415035",@"materialId":@"1224",@"page":@(page),@"pageSize":@"10",@"insideCode":@"10013",@"appType":@"1",@"ipAddress":@"115.231.110.203",@"version":@"2.1.1"};
    [[YSHTTPRequest sharedHTTPRequest] POSTWithURL:strURL withParam:dicPrograme andRequestSuccess:^(id responseObject) {
