...
@interface YSEveningViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation YSEveningViewController
...
//    appName=%E5%91%B3%E4%BB%96&keyCode=24D2B3A9D5C7B28FA42AEF35EF7C4847&timeStamp=1470617662333&materialId=1225&page=1&pageSize=10&insideCode=10013&appType=1&ipAddress=115.231.110.203&version=2.1.1&
    NSDictionary *dicPrograme = @{@"appName":@"味他",@"keyCode":@"24D2B3A9D5C7B28FA42AEF35EF7C4847",@"timeStamp":@"1470617662333",@"materialId":@"1225",@"page":@(page),@"pageSize":@"10",@"insideCode":@"10013",@"appType":@"1",@"ipAddress":@"115.231.110.203",@"version":@"2.1.1"};
    [[YSHTTPRequest sharedHTTPRequest] POSTWithURL:strURL withParam:dicPrograme andRequestSuccess:^(id responseObject) {
